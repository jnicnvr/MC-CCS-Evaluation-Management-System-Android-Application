...
public class QueryManagement extends StringRequest {

    private static final String Login_URL = "http://" + IPCONFIG + "/MCFE/ManagementEvaluation.php";
    private Map<String, String> params;

    public QueryManagement(String faculty, String acad_year, String rating1,String rating2,String rating3,String rating4,String rating5,String rating6,String rating7,String rating8,String rating9,String rating10
